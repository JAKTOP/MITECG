...
/* DEFWFDB is the default value of the WFDB path if the WFDB environment
   ...
   If WFDB_NETFILES support is disabled, the string ". /home/Administrator/wfdb-10.6.2/build/database" is
   usually sufficient for a default WFDB path, thus restricting the search for
   WFDB files to the current directory ("."), followed by /home/Administrator/wfdb-10.6.2/build/database).
...
# define DEFWFDB	". /home/Administrator/wfdb-10.6.2/build/database"
#else
# define DEFWFDB ". /home/Administrator/wfdb-10.6.2/build/database http://physionet.org/physiobank/database"
#endif
